    ...
    <div className={style.footerFullDiv}>
      <div className={style.aboutDiv}>
        ...
        <div className={style.seals}>
          <b style={{fontSize:'22px'}}>Trusted & Seals</b>
      ...
      <div className={style.midDiv}>
        <div className={style.midSub}>
          <b style={{fontSize:'22px'}}>Company</b>
          <p >Home</p>
          <p>Privacy Policy</p>
          <p>T & C</p>
          <p>Varied Payment</p>
        </div>
        <div className={style.midSub} style={{marginTop:'5vh'}}>
          <b style={{fontSize:'22px'}} >Collaborate</b>
          <p>Clever Tap</p>
          <p>Exotel</p>
          <p>Facebook</p>
          <p>Quora</p>
      ...
      <div className={style.midDiv}>
        <div className={style.midSub}>
          <b style={{fontSize:'22px'}}>Support</b>
          <p>Home</p>
          <p>Privacy Policy</p>
          <p>T & C</p>
          <p>Varied Payment</p>
        ...
        <div className={style.midSub}style={{marginTop:'5vh'}}>
          <b style={{fontSize:'22px'}}>Important Link</b>
          <p>Tarot Reader</p>
          <p>Vedic Astrology </p>
          <p>Palmistry </p>
          <p>Gemology</p>
